      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="lg:col-span-1">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-4">Plataforma industrial para monitoreo y gestión de sistemas eléctricos en tiempo real. Solución híbrida edge-cloud con IA integrada.</p>
            <div className="flex space-x-2">
              {/*<Button variant="ghost" size="sm" className="p-2">
                <Github className="h-4 w-4" />
              </Button>*/}
              <Button variant="ghost" size="sm" className="p-2">
                <a href={"https://www.linkedin.com/company/bylogos/"} target="_blank" rel="noopener noreferrer">
                  <Linkedin className="h-4 w-4" />
                </a>
              </Button>
              <Button variant="ghost" size="sm" className="p-2">
                <a href={"https://www.instagram.com/bylogos.io/"} target="_blank" rel="noopener noreferrer">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} viewport={{ once: true }}>
            ...
            <div className="mt-6">
              <a href={"mailto:contact@bylogos.io"}>
                <Button className="bg-primary hover:bg-primary/90 text-primary-foreground w-full" size="sm">
        ...
        {/* Bottom section */}
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.4 }} viewport={{ once: true }} className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-sm text-muted-foreground">© {currentYear} LogOS SCADA. Todos los derechos reservados.</div>
